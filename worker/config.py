...
class WorkerConfig:
    ...
    def from_env(cls) -> "WorkerConfig":
        ...
        return cls(
            ...
            bind_port=_get_int("WORKER_BIND_PORT", 50052),
            coordinator_target=os.getenv("WORKER_COORDINATOR_TARGET", "127.0.0.1:9000") or None,
            metrics_host=os.getenv("WORKER_METRICS_HOST", "127.0.0.1"),
            metrics_port=_get_int("WORKER_METRICS_PORT", 9101),
            health_host=os.getenv("WORKER_HEALTH_HOST", "127.0.0.1"),
            health_port=_get_int("WORKER_HEALTH_PORT", 8181),
